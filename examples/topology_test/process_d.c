...
void* receive_thread_c(void* arg) {
    ...
    while (1) {
        ...
        if (received > 0) {
            ...
            for (int i = 0; i < received; i++) {
                eproto_receive_byte(&g_eproto, 0x09,
                                    rx_buffer[i]);  // 总线9接收来自C的数据
            }
        }
        usleep(10000);
    }
...
void* receive_thread_e(void* arg) {
    ...
    while (1) {
        ...
        if (received > 0) {
            ...
            for (int i = 0; i < received; i++) {
                eproto_receive_byte(&g_eproto, 0x0A,
                                    rx_buffer[i]);  // 总线10接收来自E的数据
            }
        }
        usleep(10000);
    }
...
void* receive_thread_a(void* arg) {
    ...
    while (1) {
        ...
        if (received > 0) {
            ...
            for (int i = 0; i < received; i++) {
                eproto_receive_byte(&g_eproto, 0x08,
                                    rx_buffer[i]);  // 总线8接收来自A的数据
            }
        }
        usleep(10000);
    }
